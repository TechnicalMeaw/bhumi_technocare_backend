...
async def get_all(is_approved : Optional[bool] = None, bill_type: Optional[models.BillType] = None, engineer_id : Optional[int] = None, customer_id : Optional[int] = None,
    ...
    query = (
        ...
        .join(models.User, models.Bill.created_by == models.User.id)  # Fix join on the relationship
        .join(models.Customer, models.Bill.customer_id == models.Customer.id)  # Fix join on the relationship
